...
class CreateCadastroComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      email: '',
      senha: '',
      escolha_voluntario: 'voluntario',
      escolha_participante: 'participante'
    }
              ...
              <div className="card-body">
                <form>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="escolha_voluntario" value={this.state.escolha_voluntario} onChange={this.changeescolha_voluntarioHandler} id="flexCheckDefault" />
                    <label class="form-check-label" for="flexCheckDefault">
                      escolha_voluntario
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="escolha_participante" value={this.state.escolha_participante} onChange={this.changeescolha_participanteHandler} />
                    <label class="form-check-label" for="flexCheckDefault">
                  ...
                  <button className="btn btn-dark" onClick={this.saveOrUpdateCadastro}>Cadastrar</button>
