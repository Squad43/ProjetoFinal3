...
CadastroService.getFuncionarioById(this.state.cod_pessoa).then( (res) =>{
let cadastro= res.data;
this.setState({cod_pessoa: cadastro.cod_pessoa, nome: cadastro.nome , dataNascimento:cadastro.dataNascimento, cidade:cadastro.cidade,  cpf: cadastro.cpf, endereço: cadastro.endereço,
...
func.preventDefault();
let cadastro = {nome: this.state.nome, dataNascimento:this.state.dataNascimento, cidade:this.state.cidade, cpf:this.state.cpf,
...
<div className="form-group">
                                    ...
                                    <div className="form-group">
                                        <label> estado: </label>
                                        <input placeholder="estado" name="estado" className="form-control" value = {this.state.esatdo} onChange={this.changeestadoHandler}/>
